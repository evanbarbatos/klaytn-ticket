        ...
        {status !== FetchStatus.Fetched ? (
          ...
          <>
            ...
            {viewMode === ViewMode.TABLE ? (
              <Card
                style={{ overflowX: 'auto', boxShadow: 'rgba(0, 0, 0, 0.35) 0px 5px 15px', borderRadius: '0px' }}
                mb="32px"
              >
                <Table>
                  <thead>
            ...
            <PageButtons>
              ...
              >
                <Text style={{ color: page === 1 ? '#BDC2C4' : '#f37021' }}>Prev</Text>
              </Arrow>
              ...
              >
                <Text style={{ color: page === maxPage ? '#BDC2C4' : '#f37021' }}>Next</Text>
              </Arrow>
            </PageButtons>
          </>
        )}
