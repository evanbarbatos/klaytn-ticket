...
const TermsOfService = () => {
  return (
    <Container>
      <Text as="h1">KlaytnSwap Terms of Service</Text>
      ...
      <Text as="p">
        ...
        KlaytnSwap protocol” or the “Protocol”), among other services. The Website is one, but not the exclusive, means
      ...
      <Text as="p">
        ...
        Chain, Aptos and Ethereum. KlaytnSwap does not control or operate any version of the Protocol on any blockchain
        ...
        KlaytnSwap team is not a liquidity provider into Protocol liquidity pools and liquidity providers are
      ...
      <Text as="p">
        KlaytnSwap owns all intellectual property and other rights in the Website and its contents, including (but not
      ...
      <Text as="p">
        ...
        such as rarity scores, token explorer or token lists (which includes the KlaytnSwap default token list and
        KlaytnSwap expanded list hosted at tokenlists.org). We may also provide warning labels for certain tokens. The
      ...
      <Text as="p">
        ...
        of any other digital tokens which are transacted on KlaytnSwap.
      </Text>
      <Text as="p">
      ...
      <Text as="p">
        ...
        as otherwise expressly set forth in the terms of another offer by KlaytnSwap, you will be solely responsible to
